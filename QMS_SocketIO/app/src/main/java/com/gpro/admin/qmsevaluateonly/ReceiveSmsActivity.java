        ...
        if (isFirst) {
            ...
            switch (appType) {
                ...
                case "9":
                    ...
                    break;
                case "10":
                    intent = new Intent(ReceiveSmsActivity.this, ReceiveSmsActivity.class);
                    startActivity(intent);
                    break;
                case "11":
                    intent = new Intent(ReceiveSmsActivity.this, LcdAreaActivity.class);
                    startActivity(intent);
                    break;
                case "12":
                    intent = new Intent(ReceiveSmsActivity.this, LcdPhongKham2Activity.class);
                    startActivity(intent);
                    break;
                case "13":
                    intent = new Intent(ReceiveSmsActivity.this, LcdPhongKham1Activity.class);
                    startActivity(intent);
                    break;
            }
